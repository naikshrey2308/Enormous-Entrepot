    ...
    <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="navbar-buttons mbr-section-btn"><a class="btn btn-primary display-4" href="https://mobiri.se"><span class="mobi-mbri mobi-mbri-login mbr-iconfont mbr-iconfont-btn"></span>Sign in</a></div>
            </div>
        </div>
    </nav>
</section>
            ...
            <div class="card col-md-12 col-lg-10">
                <div class="card-wrapper">
                    <div class="card-box align-left">
                        ...
                        <div class="mbr-section-btn mt-3"><a class="btn btn-secondary display-4" href="https://mobiri.se">Create My Account</a></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="row mbr-gallery mt-4">
            <div class="col-12 col-md-6 col-lg-3 item gallery-image active">
                <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#sZRJriPrdu-modal" data-bs-target="#sZRJriPrdu-modal">
                    <img class="w-100" src="assets/images/mbr-596x403.jpeg" alt="" data-slide-to="0" data-bs-slide-to="0" data-target="#lb-sZRJriPrdu" data-bs-target="#lb-sZRJriPrdu">
                ...
                <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#sZRJriPrdu-modal" data-bs-target="#sZRJriPrdu-modal">
                    <img class="w-100" src="assets/images/mbr-2-596x397.jpeg" alt="" data-slide-to="1" data-bs-slide-to="1" data-target="#lb-sZRJriPrdu" data-bs-target="#lb-sZRJriPrdu">
                    <div class="icon-wrapper">
                        <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                    </div>
                </div>
                ...
                <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#sZRJriPrdu-modal" data-bs-target="#sZRJriPrdu-modal">
                    <img class="w-100" src="assets/images/mbr-347x231.jpeg" alt="" data-slide-to="2" data-bs-slide-to="2" data-target="#lb-sZRJriPrdu" data-bs-target="#lb-sZRJriPrdu">
                    <div class="icon-wrapper">
                        <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                    </div>
                </div>
                ...
                <div class="item-wrapper" data-toggle="modal" data-bs-toggle="modal" data-target="#sZRJriPrdu-modal" data-bs-target="#sZRJriPrdu-modal">
                    <img class="w-100" src="assets/images/mbr-596x419.jpeg" alt="" data-slide-to="3" data-bs-slide-to="3" data-target="#lb-sZRJriPrdu" data-bs-target="#lb-sZRJriPrdu">
                    <div class="icon-wrapper">
                        <span class="mobi-mbri mobi-mbri-search mbr-iconfont mbr-iconfont-btn"></span>
                    </div>
                </div>
        ...
        <div class="modal mbr-slider" tabindex="-1" role="dialog" aria-hidden="true" id="sZRJriPrdu-modal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="carousel slide carousel-fade" id="lb-sZRJriPrdu" data-interval="5000" data-bs-interval="5000">
                            ...
                            <ol class="carousel-indicators">
                                <li data-slide-to="0" data-bs-slide-to="0" class="active" data-target="#lb-sZRJriPrdu" data-bs-target="#lb-sZRJriPrdu"></li><li data-slide-to="1" data-bs-slide-to="1" class="active" data-target="#lb-sZRJriPrdu" data-bs-target="#lb-sZRJriPrdu"></li>
                                <li data-slide-to="2" data-bs-slide-to="2" data-target="#lb-sZRJriPrdu" data-bs-target="#lb-sZRJriPrdu"></li>
                                <li data-slide-to="3" data-bs-slide-to="3" data-target="#lb-sZRJriPrdu" data-bs-target="#lb-sZRJriPrdu"></li>
                                
                            </ol>
                            <a role="button" href="" class="close" data-dismiss="modal" data-bs-dismiss="modal" aria-label="Close">
                            </a>
                            <a class="carousel-control-prev carousel-control" role="button" data-slide="prev" data-bs-slide="prev" href="#lb-sZRJriPrdu">
                                <span class="mobi-mbri mobi-mbri-arrow-prev" aria-hidden="true"></span>
                                <span class="sr-only visually-hidden">Previous</span>
                            </a>
                            <a class="carousel-control-next carousel-control" role="button" data-slide="next" data-bs-slide="next" href="#lb-sZRJriPrdu">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
                <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler mx-auto" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="CWuM5LQTRaNlEF/gK+rIaaZEs3BlISv5qvKGsyl9H0cqki/HhkWoRgPfIOD0yr0rzROy41oyUAMNwpA0ZOS9OAcyk6ORbvYXf0hk5/BF4F7z5HzaLeyjyhpQ4UB3XOZW">
                    <div class="row">
